...
Example:
```
smarty --basetypes=atomtypes/basetypes-elemental.smarts --initialtypes=--basetypes=atomtypes/basetypes-elemental.smarts --decorators=atomtypes/decorators.smarts --substitutions=atomtypes/substitutions.smarts \
