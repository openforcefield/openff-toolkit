...
- `BondCharge`: This supports placement of a virtual site along a vector between two specified atoms, e.g. to allow for a sigma hole for halogens or similar contexts. ![BondCharge virtual site](figures/vsite_bondcharge.jpg | width=50 "BondCharge virtual site")
