...
| :------ |:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Latest Release** | [![Last release tag](https://img.shields.io/github/release-pre/openforcefield/openff-toolkit.svg)](https://github.com/openforcefield/openff-toolkit/releases)  [![Commits since release](https://img.shields.io/github/commits-since/openforcefield/openff-toolkit/0.11.2.svg)](https://github.com/openforcefield/openff-toolkit/releases/tag/0.11.2) [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.7225911.svg)](https://doi.org/10.5281/zenodo.7225911) |
...
Please cite the OpenFF Toolkit using the [Zenodo record](https://zenodo.org/record/7225911) of the [latest release](https://zenodo.org/record/7225911#.Y1AoFezMKrN) or the version that was used. The BibTeX reference of the latest release can be found [here](https://zenodo.org/record/7225911/export/hx#.Y1AoKezMKrM).
