...
class OpenEyeToolkitWrapper(ToolkitWrapper):
    ...
    def assign_fractional_bond_orders(self, molecule, bond_order_model=None, conformers=None):
        """
        ...
        conformers : iterable of simtk.unit.Quantity(np.array) with shape (n_atoms, 3) and dimension of distance, optional, default=None
