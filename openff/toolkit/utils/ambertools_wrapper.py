...
class AmberToolsToolkitWrapper(base_wrapper.ToolkitWrapper):
    ...
    def assign_partial_charges(
        ...
        use_conformers : iterable of simtk.unit.Quantity-wrapped numpy arrays, each
    ...
    def compute_partial_charges_am1bcc(
        ...
        molecule : Molecule
            Molecule for which partial charges are to be computed
        use_conformers : iterable of simtk.unit.Quantity-wrapped numpy arrays,
...
"""
    ...
    def assign_fractional_bond_orders(
        ...
        use_conformers : iterable of simtk.unit.Quantity(np.array) with shape (n_atoms, 3)
