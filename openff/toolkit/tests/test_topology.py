...
class TestTopology:
    ...
    def test_to_from_rdkit_hierarchy_metadata(self, topology_with_metadata):
        ...
        for orig_atom, roundtrip_atom in zip(topology_with_metadata.atoms, roundtrip_top.atoms):
            if 'residue_name' in orig_atom.metadata:
