...
class TestTopology:
    ...
    def test_group_chemically_identical_molecules(self):
        ...
        def assert_reversed_ethanol_is_grouped_correctly(groupings):
            ...
            assert next(iter(groupings[0][1])) == 1
