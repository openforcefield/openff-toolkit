...
Bugfixes
""""""""
* `PR #325 <https://github.com/openforcefield/openforcefield/pull/325>`_: Provide warning or error message as appropriate when a molecule is missing stereochemistry. Fix solvent box for provided test system to resolve periodic clashes. Add informative message when a molecule can't be matched in ``Topology.from_openmm``.
