...
- [PR #948](https://github.com/openforcefield/openforcefield/pull/948): Resolves
  ...
  (to the limit of a python float's precision, generally less than 1e-6 electron charge).
